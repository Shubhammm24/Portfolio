...
export const HeroContent = () => {
  return (
    ...
    >
      ...
      <div className="h-full w-full lg:w-1/2 flex flex-col gap-3 justify-center m-auto text-start bg-[#030014]/85 lg:bg-transparent p-6 lg:p-0 rounded-2xl lg:rounded-none border border-[#7042f84b] lg:border-none">
        <motion.div
